...
MsgBox, Original Coordinates X: %A_CaretX%, Y: %A_CaretY% `nEnter these coordinates into the console window `nOnce these numbers are entered. Click on the icon next to Warp Stabilizer under Favorites and click ALT+V
